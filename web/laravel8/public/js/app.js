...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    reset: function reset() {
      this.preview = '';
      this.photo = null; //this.$el はコンポーネントそのものの DOM 要素を指します
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                _this2.loading = false; // alert('UNPROCESSABLE_ENTITY : ' + UNPROCESSABLE_ENTITY);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  plugins: [__webpack_require__(/*! @tailwindcss/forms */ "./node_modules/@tailwindcss/forms/src/index.js")]
});
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                _this.photo = response.data; //  alert(this.photo.id);
...
createApp(); //    template: '<h1>Hello world111111</h1>'
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: " container mt-50 mx-auto bg-gray-300 text-white p-6 " },
    [
      _vm.isLogin
        ? _c(
            "button",
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "bg-gray-500 lg:bg-gray-700" }, [
    _c("header", { staticClass: "container mx-auto text-white " }, [
      _c(
        "div",
        ...
        [
          _c(
            ...
            [
              _c("h1", { staticClass: "text-4xl font-semibold md:text-xl" }, [
                _vm._v("Vuesplash")
              ])
            ]
          ),
      ...
      _c(
        "div",
        { staticClass: "md:block", class: _vm.isOpen ? "block" : "hidden" },
        [
          _c("ul", { staticClass: "md:flex md:justify-around" }, [
            _vm._m(0),
            _vm._v(" "),
            _vm._m(1),
            _vm._v(" "),
            ...
            _c("li", [
              _vm.isLogin
                ? _c("div", { staticClass: "my-8 text-center md:my-4" }, [
                    _c(
                      "button",
                      {
                        staticClass:
                          "px-6 py-2 text-black bg-red-500 hover:bg-red-700 rounded-full",
                        on: {
                          click: function($event) {
  ...
  function() {
    ...
    return _c("li", { staticClass: "border-b" }, [
      _c(
        "a",
        {
          staticClass: "block px-8 py-2 my-4 hover:bg-gray-600 rounded",
          attrs: { href: "#" }
        },
        [_vm._v("Vuesplashとは")]
      )
...
var render = function() {
  ...
  return _c("div", {}, [
    _c("ul", { staticClass: "md:flex md:justify-around" }, [
      ...
      _vm._v(" "),
      _c("li", {}, [
        _vm._v("\n      currentPage : " + _vm._s(_vm.currentPage) + "\n    ")
      ]),
      _vm._v(" "),
      _c(
        "li",
    ...
    [
      _c(
        ...
        [
          _c("div", {}, [
            _c("img", {
              staticClass: "w-full rounded h-56",
              attrs: {
                src: _vm.item.url,
              ...
              _c("li", { staticClass: "m-2" }, [
                _c(
                  "button",
                  {
                    ...
                    class: { "bg-red-500": _vm.item.liked_by_user },
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            {
              staticClass:
                "w-64 flex flex-col items-center px-4 py-6 bg-white rounded-md shadow-md tracking-wide uppercase border border-blue cursor-pointer hover:bg-purple-600 hover:text-white text-purple-600 ease-linear transition-all duration-150"
            },
            [
              _c("i", { staticClass: "fas fa-cloud-upload-alt fa-3x" }),
              _vm._v(" "),
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container bg-gray-100 mx-auto " }, [
              ...
              [
                _c(
                  "a",
                  {
                    ...
                    class: {
                      "text-indigo-600 bg-white": _vm.openTab !== 1,
                      "text-white bg-gray-500": _vm.openTab === 1
                    },
                    on: {
                      click: function($event) {
                ...
                _c(
                  "a",
                  {
                    staticClass:
                      "text-xs font-bold uppercase px-5 py-3 shadow-lg rounded block leading-normal",
                    class: {
                      "text-indigo-600 bg-white": _vm.openTab !== 2,
                      "text-white bg-gray-500": _vm.openTab === 2
                    },
                    on: {
                      click: function($event) {
                ...
                _c(
                  ...
                  [
                    _c(
                      "form",
                      {
                        staticClass: "grid grid-cols-1 gap-6 m-6",
                        on: {
                          submit: function($event) {
                            $event.preventDefault()
                      ...
                      [
                        ...
                        _c("input", {
                          ...
                          staticClass: "text-xl p-3 border rounded",
                          attrs: {
                            type: "text",
                  ...
                  [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "label",
                          { staticClass: "block", attrs: { for: "username" } },
                          [_vm._v("Name")]
                        ),
                        _vm._v(" "),
                        _c("input", {
  ...
  function() {
    ...
    return _c("div", {}, [
      _c(
        ...
        {
          staticClass:
            "mb-3 text-xl w-4/12 bg-black text-white py-2 rounded hover:opacity-75",
          attrs: { type: "submit" }
        },
        [_vm._v("login")]
      )
      ...
      _c("div", { staticClass: "border m-2" }, [
        ...
        _c("div", {}, [
          _c(
            "button",
            {
              staticClass: "h-15 w-10 hover:bg-red-800",
              class: { "h-15 w-10 bg-red-500": _vm.photo.liked_by_user },
              attrs: { title: "Like photo" },
        ...
        _c("div", [
          _vm.photo.comments.length > 0
            ? _c(
                "ul",
                { staticClass: "overflow-y-scroll h-60 bg-gray-100 " },
                _vm._l(_vm.photo.comments, function(comment) {
                  return _c(
                    "li",
                    { key: comment.content, staticClass: "border-b" },
                    [
                      _c("p", {}, [
                        _vm._v(
                          "\r\n                " +
          ...
          ? _c(
              ...
              [
                ...
                _c("textarea", {
                  ...
                  staticClass: "mt-5 w-full border-2",
  ...
  function() {
    ...
    return _c("div", {}, [
      _c(
        "button",
        {
          staticClass: "bg-black hover:bg-gray-500 text-white w-full h-15 p-2 ",
          attrs: { type: "submit" }
        },
